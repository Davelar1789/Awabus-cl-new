...
export default function AddRoute() {
  ...
  if (created) {
    return (
      <div>
        <PageHeader title="Add route" subtitle="Establish a new transport line and map assigned operational details." />
        <Card className="mx-auto max-w-lg p-8 text-center">
          ...
          <div className="mt-6 space-y-3 rounded-xl bg-slate-50 p-4 text-left text-sm dark:bg-navy">
            ...
            <Row label="Assigned Bus" value={created.assignedBus?.name || '—'} />
            <Row
              label="Driver"
              value={created.assignedDriver ? `${created.assignedDriver.firstName} ${created.assignedDriver.lastName}` : '—'}
            />
          </div>
